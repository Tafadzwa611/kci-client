...
function CustomSelectRemoteFilter({url, label, selected, queryParamName, params, setFieldValue, placeholder, isMulti, ...props}) {
...
export default CustomSelectRemoteFilter;