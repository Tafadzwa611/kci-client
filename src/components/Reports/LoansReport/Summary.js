...
function Summary({report, currencyIso, minDate, maxDate, selectedBranches, loggedInUser}) {
  ...
  return (
    <div style={{maxHeight: '500px', margin:"2rem 0", overflowY:"auto"}}>
      ...
      <table className='table' id='summary'>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{currencyIso} {report.value_of_loans_outstanding}</td>
          </tr>
          <tr>
            <td>Average Value Of Loans Outstanding <em>(All time)</em></td>
            <td>{currencyIso} {report.average_value_of_loans_outstanding}</td>
          </tr>
          ...
          <tr>
            ...
            <td>{currencyIso} {report.all_time_value_of_loans_disbursed}</td>
          </tr>

          <tr>
            <td>Penalties Accrued <em>(All time)</em></td>
            <td>{currencyIso} {report.all_time_penalty_accrued}</td>
          </tr>

          <tr>
            <td>Penalties Due <em>(All time)</em></td>
            <td>{currencyIso} {report.all_time_penalty_due}</td>
          </tr>
          ...
          <tr>
            ...
            <td>{currencyIso} {report.value_of_loans_disbursed}</td>
          </tr>
        </tbody>
      </table>
    </div>
