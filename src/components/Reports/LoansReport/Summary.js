  ...
  return (
    <div className='search_background' style={{padding:'20px'}}>
      <div style={{display:'grid', marginTop:'0.5rem', gridTemplateColumns: '1fr 1fr 1fr 1fr', columnGap: '10px'}}>
        ...
        <div>
          <ul style={{display:'flex', flexDirection:'column', rowGap:'10px'}}>
            <li style={{marginBottom:'0.5rem'}}><b>Male Clients Disbursement Info</b></li>
        ...
        <div>
          <ul style={{display:'flex', flexDirection:'column', rowGap:'10px'}}>
            <li style={{marginBottom:'0.5rem'}}><b>Female Clients Disbursement Info</b></li>
        ...
        <div>
          <ul style={{display:'flex', flexDirection:'column', rowGap:'10px'}}>
            <li style={{marginBottom:'0.5rem'}}><b>Groups Disbursement Info</b></li>
      ...
      <div style={{display:'grid', marginTop:'1.5rem', gridTemplateColumns: '1fr 1fr 1fr 1fr', columnGap: '10px'}}>
        ...
        <div>
          <ul style={{display:'flex', flexDirection:'column', rowGap:'10px'}}>
            <li style={{marginBottom:'0.5rem'}}><b>Male Clients Running Loans Info</b></li>
        ...
        <div>
          <ul style={{display:'flex', flexDirection:'column', rowGap:'10px'}}>
            <li style={{marginBottom:'0.5rem'}}><b>Female Clients Running Loans Info</b></li>
        ...
        <div>
          <ul style={{display:'flex', flexDirection:'column', rowGap:'10px'}}>
            <li style={{marginBottom:'0.5rem'}}><b>Groups Running Loans Info</b></li>
