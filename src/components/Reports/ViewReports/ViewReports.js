            ...
            <div className="card-body">
                ...
                <>
                    <div className="bloc-tabs">
                            ...
                            <button className={tab === "paymentsreport" ? "tabs-client active-tabs" : "tabs-client"} onClick={e=> setTab("paymentsreport")}> Payments </button>
                            <button className={tab === "expectedpymntrpt" ? "tabs-client active-tabs" : "tabs-client"} onClick={e=> setTab("expectedpymntrpt")}> Expected Payments </button>
                            <button className={tab === "monthlyreport" ? "tabs-client active-tabs" : "tabs-client"} onClick={e=> setTab("monthlyreport")}> Monthly </button>
                            <button className={tab === "topbrrwers" ? "tabs-client active-tabs" : "tabs-client"} onClick={e=> setTab("topbrrwers")}> Top Borrowers </button>
                            <button className={tab === "disbursmntreport" ? "tabs-client active-tabs" : "tabs-client"} onClick={e=> setTab("disbursmntreport")}> Disbursement </button>
                            <button className={tab === "loanpdtrpt" ? "tabs-client active-tabs" : "tabs-client"} onClick={e=> setTab("loanpdtrpt")}> Loan Product </button>
                            <button className={tab === "feesrpt" ? "tabs-client active-tabs" : "tabs-client"} onClick={e=> setTab("feesrpt")}> Fees Report </button>
                            <button className={tab === "loanoffrreport" ? "tabs-client active-tabs" : "tabs-client"} onClick={e=> setTab("loanoffrreport")}> loans Officer </button>
                    ...
                    <div className='tab-content font-12' style={{marginTop:"3rem"}}>
                        {{
                            ...
                            'expectedpymntrpt': <ExpectedPaymentsReport />,
