                            ...
                            {report.loans.map((loan, index) => {
                                return (
                                    <tr key={index}>
                                        ...
                                        {loan.loan_number ? <td>{loan.loan_balance}</td> : <td><b>{loan.loan_balance}</b></td>}
                                        {loan.loan_number ? <td>{loan.loan_balance_at}</td> : <td><b>{loan.loan_balance_at}</b></td>}
                                    </tr>
                                )
                            })}
                        </tbody>
