          ...
          <div style={{ marginBottom: '1rem' }}>
            <div style={{ marginBottom: '1rem', display: 'flex', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', columnGap: '5px' }}>
                <button className='btn btn-default client__details' onClick={() => setLoanId(null)}>
                  Close
                </button>
            ...
            <div style={{ marginBottom: '1rem' }} className='loans__info__container'>
              <div className='loans__info__section'>
                <span style={{ margin: '0 5px' }}><b>{loan.branch} Branch </b></span> /
                <span style={{ margin: '0 5px' }}>
                  <b>{loan.client_fullname ? loan.client_fullname : loan.group_name}</b>
                </span> /
