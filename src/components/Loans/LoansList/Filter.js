...
const Filter = ({products, setLoanData, setClientType, setLoanId}) => {
  const initialValues = {
    branch_ids: [],
    status: [],
    page_num: 1,
    ...
    client: '',
    loan_product_id: '',
    client_type: 'Clients/Pure Groups'
  };
  ...
  const onSubmit = async (values, actions) => {
    try {
      ...
      const url = values.client_type === 'Solidarity' ? '/loansapi/solidarity_loans/' : '/loansapi/loan_list/';
              ...
              <NonFieldErrors errors={errors}>
                ...
                <div className="row row-payments row-loans" style={{marginTop:"1rem"}}>
                  ...
                  <div className="row-payments-container" style={{width:"32%"}}>
                    ...
                    >
                      <option value='Clients/Pure Groups'>Clients/Pure Groups</option>
