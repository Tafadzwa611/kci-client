    ...
    <div className='sf-page'>
      <div className='sf-shell'>
        <div className='sf-shell-head'>
          <div className='sf-shell-title'>Data Export</div>
          <div className='sf-shell-subtitle'>
            Configure the export name, output format, entity, fields, and advanced filters before generating the report.
          </div>
        </div>
        ...
        <div className='sf-shell-body'>
          ...
          <section className='sf-section'>
            <div className='sf-section-head'>
              <div className='sf-section-title'>Export setup</div>
              <div className='sf-section-hint'>
                Enter the export details, choose the base entity, and select the fields to include.
              </div>
            </div>
            ...
            <div className='sf-section-body sf-stack'>
              ...
              <div className='row custom-background'>
                ...
                <div className='col-9'>
                  ...
                  {errors.base_entity ? (
                    <div className='error'>{JSON.stringify(errors.base_entity)}</div>
                  ) : null}
                </div>
              </div>
                    ...
                    <div className='col-9'>
                      <Select
                        ...
                        options={[
                          ...
                          ...fields[values.base_entity].map(field => ({
...
const processFields = fields => {
  ...
  const annotated_fields = fields
    .filter(field => field.type === 'annotation')
    .map(field => field.field_name);
