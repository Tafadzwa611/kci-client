...
function UpdateReceiptBook() {
  ...
  useEffect(() => {
    document.title = 'Update Receipt Book';
  }, []);
    ...
    <div className='sf-page'>
      <div style={{ marginBottom: 12 }}>
        <button type='button' className='btn btn-default max'>
          <Link to={`/users/admin/manageexps/receipt-book-details/${params.rbId}`}>Back</Link>
        </button>
      </div>
              ...
              <div className='sf-shell'>
                <div className='sf-shell-head'>
                  ...
                  <div className='sf-shell-subtitle'>
                    Update the receipt or voucher book details, range, mode, currency, branch, and allowed applications.
                  </div>
                </div>
                  ...
                  <section className='sf-section'>
                    <div className='sf-section-head'>
                      ...
                      <div className='sf-section-hint'>
                        Edit the basic details, choose the type, then update applications and configuration options.
                      </div>
                    </div>
