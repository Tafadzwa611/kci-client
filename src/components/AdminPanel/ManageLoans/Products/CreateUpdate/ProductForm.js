              ...
              <NonFieldErrors errors={errors}>
                <div className='sf-shell'>
                  <div className='sf-shell-head'>
                    <div className='sf-shell-title'>Loan Product</div>
                    <div className='sf-shell-subtitle'>
                      Configure product details, pricing, schedule behavior, fees, penalties, availability, and accounting mappings.
                    </div>
                  </div>
                  ...
                  <div className='sf-shell-body'>
                    <section className='sf-section'>
                      <div className='sf-section-head'>
                        <div className='sf-section-title'>Name & Description</div>
                        <div className='sf-section-hint'>
                          Enter the core product identity and basic status settings.
                        </div>
                      </div>
                      ...
                      <div className='sf-section-body sf-stack'>
                        ...
                        <CustomCheckbox
                          label='Calculate Using Installment'
                          name='calculate_using_installment'
                        />
                      </div>
                    </section>
                    ...
                    <section className='sf-section'>
                      <div className='sf-section-head'>
                        <div className='sf-section-title'>Principal Settings</div>
                        <div className='sf-section-hint'>
                          Choose the currency and define the permitted principal range.
                        </div>
                      </div>
                    ...
                    <section className='sf-section'>
                      <div className='sf-section-head'>
                        <div className='sf-section-title'>Interest Settings</div>
                        <div className='sf-section-hint'>
                          Set the interest method, interval, rate limits, and dynamic interest behavior where applicable.
                        </div>
                      </div>
                      ...
                      <div className='sf-section-body sf-stack'>
                        <CustomSelect label='Interest Method' name='interest_method' required>
                          ...
                          <option value='Reducing Balance - Equal Installments'>
                            Reducing Balance - Equal Installments
                          </option>
                          <option value='Reducing Balance - Equal Principal'>
                        ...
                        {values.product_type === 'Dynamic Term Loan' && (
                          <>
                            <CustomSelect
                              label='Apply Dynamic Interest On'
                              name='dynamic_interest_applied_on'
                              required
                            >
                              <option value=''>------</option>
                              <option value='Principal'>
                                Missed Installment Principal Balance
                              </option>
                              <option value='Org Principal'>Original Principal</option>
                              <option value='Interest'>
                                Missed Installment Interest Balance
                              </option>
                              <option value='Org Interest'>Original Balance</option>
                              <option value='Principal + Interest'>
                                Missed Installment Principal + Interest
                              </option>
                              <option value='Principal + Penalty'>
                                Missed Installment Principal + Penalty
                              </option>
                              <option value='Principal + Interest + Fees + Penalty'>
                                Missed Installment Principal + Interest + Fees + Penalty
                              </option>
                            </CustomSelect>

                            <CustomCheckbox
                              label='Add Interest After Maturity'
                              name='add_interest_after_maturity'
                            />

                            {values.add_interest_after_maturity && (
                              <CustomInput
                                label='Interest rate after maturity'
                                name='dynamic_default_interest_rate'
                                type='number'
                                required
                              />
                            )}
                    ...
                    <section className='sf-section'>
                      <div className='sf-section-head'>
                        <div className='sf-section-title'>Top-Up Settings</div>
                        <div className='sf-section-hint'>
                          Define when top-ups are allowed and the permitted limits.
                        </div>
                      </div>

                      <div className='sf-section-body sf-stack'>
                        <CustomInput
                          label='Topup Window Period In Days'
                          name='topup_window_period'
                          type='number'
                          required
                        />
                        <CustomInput
                          label='Number Of Topups Allowed Per Loan'
                          name='number_of_topups_allowed'
                          type='number'
                          required
                        />
                        <CustomInput
                          label='Maximum Top-Up Amount As A Percentage'
                          name='topup_limit'
                          type='number'
                          required
                        />
                    ...
                    <section className='sf-section'>
                      <div className='sf-section-head'>
                        <div className='sf-section-title'>Tenure Settings</div>
                        <div className='sf-section-hint'>
                          Configure repayment cycle, duration, and default schedule strategy.
                        </div>
                      </div>
                      ...
                      <div className='sf-section-body sf-stack'>
                        ...
                        <CustomInput
                          ...
                          name='maximum_loan_duration'
                          type='number'
                          required
                        />
                        <CustomInput
                          label='Default Number of Repayments'
                          name='default_loan_duration'
                          type='number'
                        />
                        <CustomInput
                          label='Days To First Repayment'
                          name='days_to_first_repayment'
                          type='number'
                          required
                        />

                        <CustomSelect
                          label='Default Loan Schedule Strategy'
                        ...
                        <CustomCheckbox
                          label='Allow Changing Schedule Strategy On Loan Creation'
                          name='allow_editing_schedule_strategy_on_loan_creation'
                        />
                      </div>
                    </section>
                    ...
                    <section className='sf-section'>
                      <div className='sf-section-head'>
                        ...
                        <div className='sf-section-hint'>
                          Set rounding precision and define the repayment priority sequence.
                        </div>
                      </div>
                      ...
                      <div className='sf-section-body sf-stack'>
                        ...
                        <CustomCheckbox
                          label='Apply Overpayment To Future Installments'
                          name='apply_overpayment_to_future_installments'
                        />
                      </div>
                    </section>
                    ...
                    <section className='sf-section'>
                      <div className='sf-section-head'>
                        <div className='sf-section-title'>Product Availability</div>
                        <div className='sf-section-hint'>
                          Define who can access the product and where it can be offered.
                        </div>
                      </div>
                    ...
                    <section className='sf-section'>
                      <div className='sf-section-head'>
                        ...
                        <div className='sf-section-hint'>
                          Configure fees attached to the product and whether they can be edited during loan creation.
                        </div>
                      </div>

                      <div className='sf-section-body sf-stack'>
                        <CustomCheckbox
                          label='Allow Editing Fees On Loan Creation'
                          name='allow_editing_fees_on_loan_creation'
                        />
                    ...
                    <section className='sf-section'>
                      <div className='sf-section-head'>
                        <div className='sf-section-title'>Custom Forms</div>
                        <div className='sf-section-hint'>
                          Add custom forms and field groupings attached to this product.
                        </div>
                      </div>
                    ...
                    <section className='sf-section'>
                      <div className='sf-section-head'>
                        <div className='sf-section-title'>Recalculate Settings</div>
                        <div className='sf-section-hint'>
                          Enable and configure auto-restructure behavior where needed.
                        </div>
                      </div>

                      <div className='sf-section-body sf-stack'>
                        <CustomCheckbox
                          label='Enable Auto Restructure'
                          name='auto_restructure'
                        />
                        ...
                        {values.auto_restructure && (
                          <>
                            <CustomInput
                              ...
                              name='auto_restructure_interest'
                              type='number'
                              required
                            />
                            <CustomInput
                              label='Recalculate Installments'
                              name='auto_restructure_installments'
                              type='number'
                              required
                            />
                          </>
                    ...
                    <section className='sf-section'>
                      <div className='sf-section-head'>
                        <div className='sf-section-title'>Defaults & Penalties</div>
                        <div className='sf-section-hint'>
                          Define default handling, penalties, write-off rules, and reminder behavior.
                        </div>
                      </div>

                      <div className='sf-section-body sf-stack'>
                        <CustomCheckbox
                          label='Allow Early Settlement On Loans With Unpaid Penalties'
                          name='allow_early_settlement_on_penalties'
                        />
                        <CustomCheckbox
                          label='Send SMS Alert On Loan Default/Installment Reminders'
                          name='send_sms_on_default'
                        />

                        <CustomSelect
                          label='Action On Default'
                          name='action_on_loan_default'
                        >
                          <option value='Do Nothing'>Do Nothing</option>
                          <option value='Add Penalty'>Add Penalty</option>
                          <option value='Add Scheduled Penalties After Maturity'>
                            Add Scheduled Penalties After Maturity
                          </option>
                          <option value='Add Scheduled Penalties After Default'>
                            Add Scheduled Penalties After Default
                          </option>
                          <option value='Add Fixed Penalty'>Add Fixed Penalty</option>
                          <option value='Add Interest'>Add Interest Fees</option>
                        </CustomSelect>

                        {values.action_on_loan_default ===
                          'Add Scheduled Penalties After Maturity' && (
                          <>
                            <CustomSelect
                              label='Apply Interest On'
                              name='apply_late_repayment_penalty_on'
                              required
                            >
                              <option value=''>------</option>
                              <option value='Total Loan Balance'>
                                Total Loan Balance In Arrears
                              </option>
                              <option value='Org Principal'>Original Principal</option>
                              <option value='Principal Balance'>
                                Principal Balance In Arrears
                              </option>
                              <option value='Interest'>
                                Interest Balance In Arrears
                              </option>
                              <option value='Principal + Interest'>
                                Principal Balance In Arrears + Interest Balance In Arrears
                              </option>
                              <option value='Principal + Penalty'>
                                Principal Balance In Arrears + Penalty Balance In Arrears
                              </option>
                            </CustomSelect>

                            <CustomCheckbox
                              label='Auto Apply Scheduled Penalties When Backdating'
                              name='auto_apply_scheduled_penalties_on_backdating'
                            />
                            <CustomCheckbox
                              label='Recalculate Scheduled Penalties'
                              name='recalculate_scheduled_penalties'
                            />
                        ...
                        {values.action_on_loan_default === 'Add Penalty' && (
                          <>
                            ...
                            <CustomSelect
                              label='Penalty Rate Interval'
                              name='penalty_charged_per'
                              required
                            >
                              <option value=''>------</option>
                              <option value='/Day'>Per Day</option>
                            ...
                            <CustomInput
                              label='Penalty Rate'
                              name='late_repayment_penalty_percentage'
                              type='number'
                              required
                            />
                            <CustomInput
                              label='Penalty Tolerance Period In Days'
                              name='grace_period'
                              type='number'
                              required
                            />
                        ...
                        {values.action_on_loan_default === 'Add Interest' && (
                          <>
                            ...
                            <CustomInput
                              ...
                              name='on_default_rate'
                              type='number'
                              required
                            />
                            <CustomCheckbox
                              label='Is recurring'
                              name='is_default_interest_recurring'
                            />
                            <CustomCheckbox
                              label='Add On Last Installment Only'
                              name='add_on_last_installment_only'
                            />
                          </>
                        )}
                        ...
                        <CustomCheckbox
                          label='Enable Auto Write-Off'
                          name='allow_auto_write_off'
                        />
                    ...
                    <section className='sf-section'>
                      <div className='sf-section-head'>
                        <div className='sf-section-title'>Accounting</div>
                        <div className='sf-section-hint'>
                          Map the accounting controls and income, receivable, payable, and write-off accounts for the selected currency.
                        </div>
                      </div>
