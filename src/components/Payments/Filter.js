            ...
            <div className="card-body">
                <form>
                    <div className="view_search_container online__applications">
                        ...
                        <div className="row-payments-container">
                            <label className="form-label row-label">Min Col Date</label>
                            <div className="input-group" style={{margin:"10px 0 0"}}>
                        ...
                        <div className="row-payments-container">
                            <label className="form-label row-label">Max Col Date</label>
                            <div className="input-group" style={{margin:"10px 0 0"}}>
                                <i class="uil uil-calendar-alt"></i>
                    ...
                    <div className="filter-container">
                        <h5 className="table-heading">View Payments</h5>
