...
function Filter({ params, setParams, onSubmit, disableFetch, loading }) {
  const fetchStyles = disableFetch
    ? { pointerEvents: "none", opacity: "0.7", width: "100%" }
    : { width: "100%" };
          ...
          <form onSubmit={onSubmit}>
            <div className="text-light">
              <div className="disbursement_date_range" style={{ border: "none" }}>
                <div
                  className="disbursement-report-fields"
                  style={{
                    display: "flex",
                    flexWrap: "wrap",
                    gap: "1rem",
                ...
                >
                  <div style={{ flex: "1 1 260px", minWidth: 0 }}>
                    <label className="form-label">
                      Excel Amount Column<span style={{ color: "red" }}>*</span>
                    </label>
                  ...
                  <div style={{ flex: "1 1 260px", minWidth: 0 }}>
                    <label className="form-label">
                      Excel Reference Column<span style={{ color: "red" }}>*</span>
                    </label>
                    <div className="reports-input-group search_input" style={{ margin: "10px 0 0" }}>
                      <input
                        className="reports-form-control"
                  ...
                  <div style={{ flex: "1 1 260px", minWidth: 0 }}>
                    <label className="form-label">
                      System Reference Column<span style={{ color: "red" }}>*</span>
                    </label>
                    <div
                      className="reports-input-group search_input"
                      style={{ margin: "10px 0 0", border: "none" }}
                    >
                      <select
                        className="report-custom-form-control currency"
                        style={{ width: "100%" }}
                        name="field_name"
                  ...
                  {params.field_name.includes("client") ? (
                    <div style={{ flex: "1 1 260px", minWidth: 0 }}>
                      <label className="form-label">
                        Start with<span style={{ color: "red" }}>*</span>
                      </label>
                      <div
                        className="reports-input-group search_input"
                        style={{ margin: "10px 0 0", border: "none" }}
                  ...
                  <div style={{ flex: "1 1 260px", minWidth: 0 }}>
                    ...
                    >
                      <select
                        ...
                        value={params.cash_account_id}
                        onChange={handleChange}
                        required
                      >
                        <option value="">Select Account</option>
                        {data[0].accounts
                          .filter((acc) => acc.currency_id == params.currencyId)
                          .map((acc) => (
                  ...
                  <div style={{ width: "100%" }}>
                    <FileUploader
                      setFileName={(fileName) =>
                        setParams((curr) => ({ ...curr, file_name: fileName }))
                      }
                    />
                    <input
                ...
                >
                  <div style={{ flex: "1 1 260px", minWidth: 0 }}>
                    <label className="form-label" style={{ marginBottom: "0" }}>
                      Include Fully and Over Paid loans<span style={{ color: "red" }}>*</span>
                    </label>
                    <div
                      className="reports-input-group search_input"
                      style={{ margin: "10px 0 0", border: "none", width: "100%" }}
                    >
                      <select
                        className="report-custom-form-control currency"
                        style={{ width: "100%" }}
                        name="include_fp_op"
                        value={params.include_fp_op}
                        onChange={handleChange}
                      >
                  ...
                  <div style={{ flex: "0 1 180px", minWidth: "160px" }}>
                    ...
                    <div className="reports-input-group search_input" style={{ margin: "10px 0 0" }}>
                      {loading ? (
                        <button type="submit" className="btn btn-olive" style={{ width: "100%" }}>
