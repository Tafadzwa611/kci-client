                ...
                <form>
                    <div className="view_search_container online__applications">
                        <div className="row-payments-container">
                            <label className="form-label row-label">Enter Asset Name</label>
                            <div className="input-group" style={{margin:"10px 0 0"}}>
                                <i class="uil uil-search"></i>
                                <input className="custom-select-form row-form input-background" placeholder="Enter Asset Name..."/>
                            </div>
                        </div>
                        <div className="row-payments-container">
                    ...
                    <div className="filter-container">
                        <h5 className="table-heading">View Assets</h5>
