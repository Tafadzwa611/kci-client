...
const LoadMoreButton = ({
    ...
    return (
      <div className='load-btn' style={{border:"none"}}>
          <button className="btn btn-olive" style={styles} name='moreClients' onClick={loadMoreClients}>
            {loadingMore ? 'Please wait..' : 'View More Clients'}
          </button>
      </div>
    )
  }
