...
import PendingApprovalFilter from './PendingApprovalFilter';
import PendingApprovalFooter from './PendingApprovalFooter';
...
function PendingApprovalList() {
  ...
  function getUrl() {
    let url = `/clientsapi/pending_approval_clients/?page_num=${pageNum.current}`;
    if (branchIds !== null) {
