...
/**
 * AddClientForm (Stripe-skin solution)
 * - Minimal JSX changes: wraps existing sections in <FormSection />
 * - Keeps Formik + yup + your existing components intact
 * - Adds modern Stripe-like layout + dark mode via CSS (included below)
 */
              ...
              <div className="sf-page">
                <div className="sf-shell">
                  ...
                  <div className="sf-shell-body">
                    ...
                    <FormSection title="Identification" hint="National ID / Passport / Licence details.">
                      <ClientId
                    ...
                    <FormSection title="Next Of Kin" hint="At least one next-of-kin record is required.">
                      <NextOfKin
