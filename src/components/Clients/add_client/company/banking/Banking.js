  ...
  return (
    <>
      ...
      <div className="load-more-container">
        <button onClick={e => setTab('dirs')} type='button' className='btn btn-default'>Back</button>
        <button onClick={e => setTab('bfiles')} type='button' className='btn btn-info'>Next</button>
      </div>
    </>
  )
}
