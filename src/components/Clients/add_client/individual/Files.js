  ...
  return (
    <>
      <div className='text-light'>
        ...
        <div className="table-container client_files">
            <div className='table-responsive'>
                <table className='table' id='chart' style={{width:"100%"}}>
                    <thead>
                    <tr className="client_files_thead">
                        <th>File Name</th>
                        <th>File Size</th>
                        <th>Action</th>
                    </tr>
                    ...
                    {selectedFiles.length > 0 ?
                        ...
                        <tr className="client_files_body" style={{borderTop:"0"}}><td colSpan={3} style={{textAlign: 'center'}}>No selected files.</td></tr>}
                    </tbody>
                </table>
            </div>
        </div>
      ...
      <div className="load-more-container">
        <button onClick={e => setTab('kin')} type='button' className='btn btn-default'>Back</button>
