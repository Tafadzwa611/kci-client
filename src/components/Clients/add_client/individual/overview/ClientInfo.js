  ...
  return (
    <div className="text-light">
      <div className='form-group row' style={{marginTop: '15px'}}>
        <label className='col-sm-1 control-label'>First Name</label>
      ...
      <div className='form-group row' style={{marginTop: '15px'}}>
        <label className='col-sm-1 control-label'>Last Name</label>
        <div className='col-sm-5'>
      ...
      <div className='form-group row' style={{marginTop: '15px'}}>
        <label className='col-sm-1 control-label'>Client Registration Date</label>
        <div className='col-sm-5'>
      ...
      <div className='form-group row' style={{marginTop: '15px'}}>
        <label className='col-sm-1 control-label'>Phone Number</label>
        <div className='col-sm-5'>
      ...
      <div className='form-group row' style={{marginTop: '15px'}}>
        <label className='col-sm-1 control-label'>Identification Number</label>
        <div className='col-sm-5'>
      ...
      <div className='form-group row' style={{marginTop: '15px'}}>
        <label className='col-sm-1 control-label'>Identification Type</label>
        <div className='col-sm-5'>
          <input
            type='text'
