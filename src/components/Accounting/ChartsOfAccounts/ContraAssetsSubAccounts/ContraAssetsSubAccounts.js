...
const ContraAssetsSubAccounts = () => {
    ...
    function getUrl() {
        let url = `/acc-api/chartsofaccs-sub-accounts-list/?currency_id=${currencyId}&acc_type=CONTRA ASSET`;
        if (branchIds !== null) {
...
export default ContraAssetsSubAccounts;