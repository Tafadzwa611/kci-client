...
import DateRange from '../../SubAccounts/AccountStatement/DateRange';
import Empty from '../../SubAccounts/AccountStatement/Empty';
import AccountTransactions from './AccountTransactions';
import { makeRequest, getFormattedDate } from '../../../../../utils/utils';

const LiabilitiesAccountStatement = (
    {selectedSubAccID, 
    setAccStatement, 
    generalLedgerName, 
    generalLedgerCode, 
...
export default LiabilitiesAccountStatement;