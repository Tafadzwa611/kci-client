...
import LiabilitiesAccountStatement from './LiabilitiesAccountStatement/LiabilitiesAccountStatement';

const LiabilitiesTable = ({ subaccounts, accStatement, setAccStatement, selectedSubAccID, setSelectedSubAccID }) => {
