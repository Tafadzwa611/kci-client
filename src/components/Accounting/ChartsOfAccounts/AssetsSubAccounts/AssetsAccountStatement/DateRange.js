...
const DateRange = ({    
    ...
    return (
        <div className="col-12 font-12 balance_sheet_date_range text-light" style={{border:"none", padding:"0 1.5rem"}}>
            <form>
                <div className="view_search_container online__applications font-13 acc__statement-search" style={{border:"none", padding:"0", marginBottom:'1.5rem', display:"flex", justifyContent:"space-between", flexDirection:"row"}}>
