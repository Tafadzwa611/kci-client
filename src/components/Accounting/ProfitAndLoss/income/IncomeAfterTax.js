  ...
  return (
    <>
      <tr>
        ...
        <td align='right' style={{fontWeight: 'bold'}}><input type='text' className='custom-select-form row-form input-background' value={`${currencyIso} ${netIncomeAfterTax}`} readOnly/></td>
      </tr>
    </>
  )
}
